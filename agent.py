...
def search_flights(destination: str, departure_date: str) -> dict:
    ...
    Use this tool when a customer asks about flight availability or pricing.
    ...
    available_flights = {
        "paris": [{"flight_no": "AF123", "price_usd": 500, "airline": "Air France"}],
        "tokyo": [{"flight_no": "JL456", "price_usd": 800, "airline": "Japan Airlines"}],
    }
